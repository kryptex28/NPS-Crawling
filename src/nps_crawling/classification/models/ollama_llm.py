...
class Ollama_LLM(ClassificationModel):
    ...
    def __init__(self, model_name: str, **kwargs):
        ...
        self.client = Client(host=f"{self.kwargs.get('host', 'localhost')}:{self.kwargs.get('port', 14000)}")
    ...
    def classify(self, text: str, category: ClassificationCategory) -> DataEntry:
        ...
        results = category.extract_from_string(response['message']['content'].strip())
        return results